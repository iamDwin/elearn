                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                        <tbody>
                                <tr> <td><?php echo $depdet['depID'];?></td>  <td><?php echo $depdet['departmentName'];?></td></tr>
                                <tr> <td class="text-bold"> Number Of Lecturers </td>  <td><?php echo $getlecNum;?></td></tr>
                                <tr> <td class="text-bold"> Number Of Students </td>  <td><?php echo $getlecNum;?></td></tr>
                                <tr> <td class="text-bold"> Number Of Courses </td>  <td><?php echo $getlecNum;?></td></tr>
                        </tbody>
