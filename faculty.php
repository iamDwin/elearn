                ...
                <div class="card-body">
                  <form class="form" method="post" enctype="multipart/form-data" onsubmit="return confirm('SAVE FACULTY ?');" >
                    ...
                    <div class="form-footer">
                      <button type="submit" name="addFac" class="btn btn-primary btn-block">SAVE FACULTY <i class="fe fe-save"></i></button>
                    </div>
                  </form>
                </div>
              </div>
                          ...
                          <td class="text-center">
                            <div class="item-action dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a href="./faculty?fid=<?php echo $facRow['facID'];?>" class="dropdown-item text-primary"><i class="dropdown-icon fe fe-edit"></i> Update </a>
                                <a href="./delfac?fid=<?php echo $facRow['facID'];?>" class="dropdown-item text-danger"><i class="dropdown-icon fe fe-trash"></i> Delete </a>
                              </div>
                            </div>
                          </td>
                        </tr>
