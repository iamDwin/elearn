            ...
            <div class="card">
                ...
                <div class="card-body">
                  <form class="form" method="post" enctype="multipart/form-data" onsubmit="return confirm('SAVE DEPARTMENT ?');" >
                      ...
                      <div class="form-group">
                      <label class="form-label"><i class="fe fe-user"></i> Lecturer Position<span class="form-required">*</span></label>
                        <div class="input-icon">
                            <select class="form-control" name="staffcat" required>
                                <option></option>
                    ...
                    <div class="form-footer">
                        <button type="submit" name="addDep" class="btn btn-primary btn-block" <?php if(!$allfac){ echo 'disabled';}?> >
